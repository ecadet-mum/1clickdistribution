                        ...
                        <div className="row footer-theme partition-f">
                            <div className="col-lg-4 col-md-6">
                                ...
                                <div className="footer-contant">
                                    ...
                                    <p>1 click distribution is the best store for you if you want to buy ........Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                            ...
                            <div className="col offset-xl-1">
                                <div className="sub-title">
                                    ...
                                    <div className="footer-contant">
                                        <ul>
                                            {/*<li><Link to={`${process.env.PUBLIC_URL}/left-sidebar/collection`} >My orders</Link></li>*/}
                                ...
                                <div className="sub-title">
                                    ...
                                    <div className="footer-contant">
                                        <ul className="contact-list">
                                            <li><i className="fa fa-map-marker"></i>1Click Distribution Store, Strore in Port-au-Prince
                                            </li>
                                            <li><i className="fa fa-phone"></i>Call Us: 509 47495050</li>
                                            <li><i className="fa fa-envelope-o"></i>Email Us: <a
                                                href="#">1clikdistribution@gmail.com</a></li>
                        ...
                        <div className="row">
                            <div className="col-xl-6 col-md-6 col-sm-12">
                                <div className="footer-end">
                                    <p><i className="fa fa-copyright" aria-hidden="true"></i> 2020- Emmanuel Cadet</p>
                                </div>
                            </div>
                            <div className="col-xl-6 col-md-6 col-sm-12">
