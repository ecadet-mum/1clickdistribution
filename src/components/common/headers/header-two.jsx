                                            ...
                                            <div className="icon-nav">
                                                <ul>
                                                    ...
                                                    <li className="onhover-div mobile-setting">
                                                        <div>
                                                            <img src={`${process.env.PUBLIC_URL}/assets/images/icon/setting.png`} className="img-fluid" alt="" />
                                                        ...
                                                        <div className="show-div setting">
                                                            ...
                                                            <ul>
                                                                ...
                                                                <li><a href={null} onClick={() => this.changeLanguage('cr')}>Creole</a> </li>
                                                            </ul>
                                                            <h6>currency</h6>
                                                            <ul className="list-inline">
                                                                <li><a href={null} onClick={() => this.props.changeCurrency('$')}>US dollar</a> </li>
                                                                <li><a href={null} onClick={() => this.props.changeCurrency('HTG')}>HTG</a> </li>
