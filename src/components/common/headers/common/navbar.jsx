                ...
                <div className="main-navbar">
                    <div id="mainnav" >
                        ...
                        <ul className="nav-menu" style={this.state.navClose}>
                            ...
                            <li >
                                <Link to={`${process.env.PUBLIC_URL}/`} className="nav-link" onClick={(e) => this.handleSubmenu(e)} style={{paddingRight: '20px'}}>
                                    {translate('home')}
                            ...
                            <li><Link to={`${process.env.PUBLIC_URL}/pages/about-us`}  style={{paddingRight: '20px'}} onClick={this.closeNav.bind(this)} >{translate('about_us')}</Link></li>

                            <li ><Link to={`${process.env.PUBLIC_URL}/pages/search`} style={{paddingRight: '20px'}} onClick={this.closeNav.bind(this)} >{translate('search')}</Link></li>


                            <li ><Link to={`${process.env.PUBLIC_URL}/pages/contact`} style={{paddingRight: '20px'}} onClick={this.closeNav.bind(this)} >{translate('contact')}</Link></li>
                            <li ><Link to={`${process.env.PUBLIC_URL}/pages/dashboard`} style={{paddingRight: '0px'}} onClick={this.closeNav.bind(this)} >{translate('dashboard')}</Link></li>
